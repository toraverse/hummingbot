...
class VolumeBenchmarkStrategyConfig(BaseClientModel):
    ...
    market: str = Field(default="ETH-USD", client_data=ClientFieldData(
    ...
    min_order_amount: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    max_order_amount: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    min_interval: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    max_interval: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    max_pending_orders: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    max_order_age_buy: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    max_order_age_sell: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))

    order_price_interval_percentage: str = Field("binance_paper_trade", client_data=ClientFieldData(
        prompt_on_new=True, prompt=lambda mi: "Exchange where the bot will trade"))


class VolumeBenchmarkStrategy(ScriptStrategyBase):
    ...
    def __init__(self, connectors: Dict[str, ConnectorBase], config: VolumeBenchmarkStrategyConfig):
